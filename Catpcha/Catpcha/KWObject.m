...
//xxxz                CGPoint loc = slf.position;
//xxxz                CGPoint last = [[change valueForKey:@"old"] CGPointValue];
//xxxz                CGFloat angle = [slf angle:last end:loc];
//xxxz                slf.heading = angle;
            }
        }];
