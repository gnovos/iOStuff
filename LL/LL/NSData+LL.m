...
//	outputLength.
//
+ (void *) decode:(const char *)inputBuffer length:(size_t)length outputLength:(size_t*)outputLength {
	if (length == -1)
	{
...
//	outputLength.
//
+ (char *) encode:(const void *)buffer length:(size_t)length separateLines:(BOOL) separateLines outputLength:(size_t*)outputLength
{
